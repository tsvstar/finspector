...
#@tsv 04/06/2015 - added MOUNT POINT as symlink for win
	...
	IO_REPARSE_TAG_MOUNT_POINT = 0xA0000003
        ...
        def find_data_to_stat(data):
            ...
            if (attributes & FILE_ATTRIBUTE_REPARSE_POINT and
                    data.dwReserved0 in [ IO_REPARSE_TAG_SYMLINK,IO_REPARSE_TAG_MOUNT_POINT ]):
        ...
        class Win32DirEntryPython(object):
            ...
            def is_symlink(self):
                return (self._find_data.dwFileAttributes &
                        ...
                        self._find_data.dwReserved0 in [ IO_REPARSE_TAG_SYMLINK, IO_REPARSE_TAG_MOUNT_POINT ])
